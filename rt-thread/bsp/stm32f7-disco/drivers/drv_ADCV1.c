...
#define PHASE_TEMP_CHANNEL     ADC_CHANNEL_8   /*ADC1 TEMP motor temp*/
#define PHASE_TEMP_PIN         GPIO_PIN_0
#define PHASE_TEMP_PORT       	GPIOB


#define TEMP_CHANNEL     ADC_CHANNEL_10/*ADC2 UD  FAN temp*/
...
void QIEMW_ADC_init(QIEMW_ADC_HandleTypeDef *QIEMW_ADC_Handle)
{
	...
	QIEMW_ADC_Handle->Temp.FANTEMP_offset= 0;
	...
	QIEMW_ADC_Handle->Temp.FANTEMP_value= 0;
...
void HAL_ADCEx_InjectedConvCpltCallback(ADC_HandleTypeDef* hadc)
{
	...
	Global_User_ADC.Temp.FANTEMP_value= (s16)HAL_ADCEx_InjectedGetValue(hadc, ADC_INJECTED_RANK_4);
	hadc->Instance = ADC3;
...
//    }
	...
	sHal_AdcData.IdcBus = Global_User_ADC.Temp.TEMP_value;
...
extern void ADC_CalibrationAll(void)
{
	...
	ADCConfigInjected.InjectedChannel = TEMP_CHANNEL;
	ADCConfigInjected.InjectedNbrOfConversion = 4;
	ADCConfigInjected.InjectedRank = 4;
